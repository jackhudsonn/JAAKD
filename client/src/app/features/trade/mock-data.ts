...
export const MOCK_ASSETS: MockAsset[] = [
  ...
  { symbol: 'NVDA', name: 'NVIDIA Corp.', instrumentType: 'stock', basePrice: 118.6, volatility: 0.03 },
  { symbol: 'AMZN', name: 'Amazon.com Inc.', instrumentType: 'stock', basePrice: 186.3, volatility: 0.02 },
  { symbol: 'IBM', name: 'IBM Corp.', instrumentType: 'stock', basePrice: 231.4, volatility: 0.015 },
  { symbol: 'GOVT', name: 'US Treasury 10-20yr Bond ETF', instrumentType: 'bond', basePrice: 24.1, volatility: 0.005 },
  { symbol: 'BND', name: 'Total Bond Market ETF', instrumentType: 'bond', basePrice: 72.8, volatility: 0.004 },
  { symbol: 'IONQ', name: 'IonQ Inc.', instrumentType: 'stock', basePrice: 72.8, volatility: 0.004 },
];
